...
// const usernames = new StorageContainer<string>();  //creating instance for the class
// usernames.addItem("simrah")
// usernames.addItem("hadi")
// usernames.addItem("jannat")
// console.log(usernames.getItem(0));

// const friends = new StorageContainer<number>();  //creating instance for the class
// friends.addItem(2)
// friends.addItem(3)
// friends.addItem(2)
...
// interface Employee {
//     readonly id: number;  // readonly means it cannot be changed
//     startDate: Date;
//     name: string;
//     department: string;
// }
...
//     id: 123,  // readonly means it cannot be changed
//     startDate: new Date(),
//     name: "Simrah",
//     department: "Software Development"
// }

// employee.name = "Hadi"; // this is allowed
// employee.id = 456; // this will throw an error because id is readonly